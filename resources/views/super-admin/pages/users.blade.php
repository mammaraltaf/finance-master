...
<div class="card-body py-3">
                ...
                <div class="modal-body">
                    <form id="categoryForm" method="POST" action="{{ route('super-admin.add-user-post') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="email" name="email" placeholder="Enter email" class="form-control input-lg"
                                    required>
                            </div>
                            <br>
                            ...
                            <div>
                                <input type="password" name="password" auto-complete="off" class="form-control input-lg"
                                    required>
                            </div>
                            <br>
    ...
    <div class="overflow-auto">
        ...
        {{-- All Datatable --}}
        <table name="categoryTable" id="categoryTable" class="table table-striped table-bordered dt-responsive nowrap"
            style="width:100%">
...
<div class="modal fade modal1" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <form id="categoryForm1" method="POST" action="{{ route('super-admin.delete-user') }}"
                enctype="multipart/form-data">
                @csrf
                        ...
                        <div id="edit-single-company">
                            <select name="company" class="form-control" aria-placeholder="Select company" required>
                                ...
                                <option value="{{ $company->name }}"
                                    {{ $company->name == $user->company ? 'selected' : '' }}>{{ $company->name }}
                                </option>
                                @endforeach
                            </select>
                        </div>
...
$('body').on('click', '#userEdit', function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#userFormEdit').attr('action', "{{ url('/super-admin/edit-user/') }}" + '/' +
                user_id);
        }
